...
import com.example.stockapp.models.MessageResponse;
import com.example.stockapp.models.User1;
import com.example.stockapp.repositories.UserRepository;
...
public class UserController {
    ...
    public ResponseEntity<?> Stringreactuserapi(@RequestBody User1 user) throws AddressException, MessagingException {
        user.setAdmin(false);
